...
## exercise : Bar plots with color ramp, part2
...
##### Exercise: Periods of recession (need recess df)
...
###### exercise : using geoms in qplot part1
...
#You can use either geom_point() or geom_dotplot() to draw dotplots, but the latter is preferred for clarity of code.
qplot(
  cyl, wt,
  data = mtcars,
  fill = am,
